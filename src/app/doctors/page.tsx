...
export default function DoctorsPage() {
  ...
  const { selectedBranchId, isLoading: storeLoading, showToast } = usePCMSStore();
    ...
    <div className="doctors-container animate-fade-in">
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Manage clinical personnel, certifications, and multi-site assignments.</p>
        </div>
        <button 
