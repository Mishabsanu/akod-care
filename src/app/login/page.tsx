      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            <p style={{ fontSize: '1.2rem', opacity: 0.7, fontWeight: 500, maxWidth: '480px', lineHeight: 1.6, marginBottom: '3.5rem' }}>
                Unified Physiotherapy Management. Secure clinical records, multi-branch revenue tracking, and specialized patient logistics at your fingertips.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', maxWidth: '500px' }}>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '0.8rem', opacity: 0.5 }}>Dynamic synchronization across clinical sites.</p>
                    </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
        ...
        <div style={{ position: 'absolute', bottom: '4rem', left: '5rem', display: 'flex', alignItems: 'center', gap: '1.5rem', opacity: 0.4 }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 900, letterSpacing: '0.1em' }}>POWERED BY PHYSIO-NET</span>
      ...
      <div style={{ 
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.75rem' }}>Clinical Email</label>
                    <div style={{ position: 'relative' }}>
                        <Mail style={{ position: 'absolute', left: '1.25rem', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }} size={18} />
                        <input 
                            required
                            type="email" 
                            value={formData.email}
                            onChange={(e) => setFormData({...formData, email: e.target.value})}
                            placeholder="specialist@akodcare.com"
                            style={{ 
                                width: '100%', 
