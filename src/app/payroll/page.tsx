...
export default function PayrollPage() {
  ...
  const handleProcessPayment = async (staff: PayrollRecord) => {
    ...
    const staffBranchId = (staff.branch as any)?._id || staff.branch;
    const resolveBranch = staffBranchId || user?.branchId;
  ...
  return (
    <div className="payroll-container animate-fade-in">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '3rem' }}>
        <div>
            <h1 style={{ fontSize: '2rem', fontWeight: 950, letterSpacing: '-0.02em' }}>Salary & <span className="gradient-text">Payroll Registry</span></h1>
