...
export default function PayrollDetailsPage() {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center h-[80vh] gap-4">
      ...
      <p className="font-bold text-slate-400 animate-pulse text-xs tracking-widest">🛡️ SECURING FINANCIAL DATA...</p>
    </div>
  );
        ...
        <div className="col-8">
          <div className="clinical-form-card" style={{ height: '100%' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', marginTop: '1rem' }}>
              ...
              <div className="spec-block">
                <label className="label-premium" style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Building size={14} style={{ color: 'var(--primary)' }} /> BASE BRANCH
                </label>
                <div style={{ fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)' }}>
                  {record.branchName || 'Clinical Admin'}
                </div>
              </div>
            </div>
